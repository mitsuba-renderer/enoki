...
void bind_cuda_pcg32(py::module& m) {
    ...
    py::class_<PCG32C>(m, "PCG32C")
        ...
        .def("seed", &PCG32C::seed,
             ...
             "initseq"_a = PCG32_DEFAULT_STREAM)
        .def("next_uint32",
             (UInt32C (PCG32C::*) (const MaskC &)) & PCG32C::next_uint32,
             "mask"_a = true)
        .def("next_uint32_bounded",
             (UInt32C (PCG32C::*) (uint32_t, const MaskC &)) & PCG32C::next_uint32_bounded,
             "bound"_a, "mask"_a = true)
        .def("next_uint64",
             (UInt64C (PCG32C::*) (const MaskC &)) & PCG32C::next_uint64,
             "mask"_a = true)
        .def("next_uint64_bounded",
             (UInt64C (PCG32C::*) (uint64_t, const MaskC &)) & PCG32C::next_uint64_bounded,
             "bound"_a, "mask"_a = true)
        .def("next_float32",
             (FloatC (PCG32C::*) (const MaskC &)) & PCG32C::next_float32,
             "mask"_a = true)
