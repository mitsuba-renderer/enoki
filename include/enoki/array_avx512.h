...
template <bool Approx, RoundingMode Mode, typename Derived> struct ENOKI_MAY_ALIAS alignas(64)
    StaticArrayImpl<float, 16, Approx, Mode, Derived> : StaticArrayBase<float, 16, Approx, Mode, Derived> {
    ...
    ENOKI_INLINE Derived or_(const Mask &a) const {
    ...
    template <typename Mask>
    ENOKI_INLINE Derived and_(const Mask &a) const {
    ...
    template <typename Mask>
    ENOKI_INLINE Derived xor_(const Mask &a) const {
        #if defined(ENOKI_X86_AVX512DQ)
    ...
    ENOKI_INLINE auto lt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_LT_OQ));  }
    ENOKI_INLINE auto gt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_GT_OQ));  }
    ENOKI_INLINE auto le_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_LE_OQ));  }
    ENOKI_INLINE auto ge_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_GE_OQ));  }
    ENOKI_INLINE auto eq_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_EQ_OQ));  }
    ENOKI_INLINE auto neq_(Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_ps_mask(m, a.m, _CMP_NEQ_UQ)); }
    ...
    static ENOKI_INLINE void transform_(void *mem, Index index, const Func &func,
                                        const Args &... args) {
...
template <bool Approx, RoundingMode Mode, typename Derived> struct ENOKI_MAY_ALIAS alignas(64)
    StaticArrayImpl<double, 8, Approx, Mode, Derived> : StaticArrayBase<double, 8, Approx, Mode, Derived> {
    ...
    ENOKI_INLINE auto lt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_LT_OQ));  }
    ENOKI_INLINE auto gt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_GT_OQ));  }
    ENOKI_INLINE auto le_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_LE_OQ));  }
    ENOKI_INLINE auto ge_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_GE_OQ));  }
    ENOKI_INLINE auto eq_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_EQ_OQ));  }
    ENOKI_INLINE auto neq_(Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_pd_mask(m, a.m, _CMP_NEQ_UQ)); }
...
template <typename Value_, typename Derived> struct ENOKI_MAY_ALIAS alignas(64)
    ...
    ENOKI_INLINE auto lt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_LT));  }
    ENOKI_INLINE auto gt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_GT));  }
    ENOKI_INLINE auto le_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_LE));  }
    ENOKI_INLINE auto ge_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_GE));  }
    ENOKI_INLINE auto eq_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_EQ));  }
    ENOKI_INLINE auto neq_(Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi32_mask(m, a.m, _MM_CMPINT_NE)); }
...
template <typename Value_, typename Derived> struct ENOKI_MAY_ALIAS alignas(64)
    ...
    ENOKI_INLINE auto lt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_LT)); }
    ENOKI_INLINE auto gt_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_GT)); }
    ENOKI_INLINE auto le_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_LE)); }
    ENOKI_INLINE auto ge_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_GE)); }
    ENOKI_INLINE auto eq_ (Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_EQ)); }
    ENOKI_INLINE auto neq_(Arg a) const { return mask_t<Derived>::from_k(_mm512_cmp_epi64_mask(m, a.m, _MM_CMPINT_NE)); }
...
struct StaticMaskImpl<Value_, Size_, Approx_, Mode_, Derived_,
    ...
    using KMask = std::conditional_t<Size_ == 16, __mmask16, __mmask8>;
    ...
    template <typename Array, std::enable_if_t<std::is_same<KMask, typename Array::Derived::KMask>::value, int> = 0>
    ENOKI_INLINE StaticMaskImpl(const Array &k, detail::reinterpret_flag) : k(k.derived().k) { }
    ENOKI_INLINE StaticMaskImpl(const Scalar &s) : k(reinterpret_array<KMask>(s)) { }

    template <typename T>
    ENOKI_INLINE static Derived from_k(const T &k) {
        Derived result;
        result.k = (KMask) k;
        return result;
    }

    ENOKI_REINTERPRET_MASK(bool, 16) {
    ...
    ENOKI_REINTERPRET_MASK(float, 8)
        : k(_mm256_test_epi32_mask(_mm256_castps_si256(a.derived().m),
                                   _mm256_castps_si256(a.derived().m))) { }
    ENOKI_REINTERPRET_MASK(int32_t, 8)  : k(_mm256_test_epi32_mask(a.derived().m, a.derived().m)) { }
    ENOKI_REINTERPRET_MASK(uint32_t, 8) : k(_mm256_test_epi32_mask(a.derived().m, a.derived().m)) { }
#else
    ENOKI_REINTERPRET_MASK(float, 8)    : k((KMask) _mm256_movemask_ps(a.derived().m)) { }
    ENOKI_REINTERPRET_MASK(int32_t, 8)  : k((KMask) _mm256_movemask_ps(_mm256_castsi256_ps(a.derived().m))) { }
    ENOKI_REINTERPRET_MASK(uint32_t, 8) : k((KMask) _mm256_movemask_ps(_mm256_castsi256_ps(a.derived().m))) { }
#endif

    ENOKI_REINTERPRET_MASK(double, 16)   { k = _mm512_kunpackb(high(a).k, low(a).k); }
    ENOKI_REINTERPRET_MASK(int64_t, 16)  { k = _mm512_kunpackb(high(a).k, low(a).k); }
    ENOKI_REINTERPRET_MASK(uint64_t, 16) { k = _mm512_kunpackb(high(a).k, low(a).k); }

#undef ENOKI_REINTERPRET_MASK

    ENOKI_INLINE Derived eq_(const Derived &a) const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_kxnor((__mmask16) k, (__mmask16) a.k));
        else
    ...
    ENOKI_INLINE Derived neq_(const Derived &a) const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_kxor((__mmask16) k, (__mmask16) a.k));
        else
            return Derived::from_k(k ^ a.k);
    }
    ...
    ENOKI_INLINE Derived or_(const Derived &a) const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_kor((__mmask16) k, (__mmask16) a.k));
        else
            return Derived::from_k(k | a.k);
    }
    ...
    ENOKI_INLINE Derived and_(const Derived &a) const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_kand((__mmask16) k, (__mmask16) a.k));
        else
            return Derived::from_k(k & a.k);
    }
    ...
    ENOKI_INLINE Derived andnot_(const Derived &a) const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_kandn((__mmask16) a.k, (__mmask16) k));
        else
            return Derived::from_k(k & ~a.k);
    }
    ...
    ENOKI_INLINE Derived not_() const {
        if (Size_ == 16) /* Use intrinsic if possible */
            return Derived::from_k(_mm512_knot((__mmask16) k));
        else
    ...
    template <typename T>
    ENOKI_INLINE size_t compress_(T *&ptr, const Derived &mask) const {
        store_unaligned(ptr, KMask(_pext_u32((unsigned int) k, (unsigned int) mask.k)));
        return count(mask);
    }

    ENOKI_INLINE void store_unaligned_(void *mem) const { memcpy(mem, &k, sizeof(KMask)); }
    ENOKI_INLINE void store_(void *mem) const { memcpy(mem, &k, sizeof(KMask)); }

    ENOKI_INLINE static Derived load_unaligned_(const void *mem) { Derived m; memcpy(&m.k, mem, sizeof(KMask)); return m; }
    ENOKI_INLINE static Derived load_(const void *mem) { Derived m; memcpy(&m.k, mem, sizeof(KMask)); return m; }

    ENOKI_INLINE auto low_()  const { return Mask<uint64_t, Size_ / 2>::from_k(__mmask8(k)); }
    ENOKI_INLINE auto high_() const { return Mask<uint64_t, Size_ / 2>::from_k(__mmask8(k >> (Size_ / 2))); }
};
